    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8 row">
                ...
                <h1 style="color:#EF3B2D ">¿Buscando desarrollador PHP?</h1>

                </div>
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                    <h3  style="color:white ">No busques más yo soy el candidato que buscas...</h3>

                </div>
                <center> <a href="https://linktr.ee/CristobalNyram" class="text-white" style="color:white">Click aquí.</a></center>
